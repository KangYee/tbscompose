...
package io.github.kangyee.tbscompose.library
...
import io.github.kangyee.tbscompose.library.LoadingState.Finished
import io.github.kangyee.tbscompose.library.LoadingState.Loading
...
public fun TbsWebView(
    ...
    client: TbsWebViewClient = remember { TbsWebViewClient() },
    chromeClient: TbsWebChromeClient = remember { TbsWebChromeClient() },
...
public open class TbsWebViewClient : WebViewClient() {
...
public open class TbsWebChromeClient : WebChromeClient() {
    public open lateinit var state: WebViewState
        internal set
 ...
 *
 * @param data The uri to load in the WebView
 * @sample io.github.kangyee.tbscompose.SaveStateExample
 */
@Composable
